...
### Elcipse spectra
elipse = np.array([0.000367, 0.000431, 0.000414, 0.000482, 0.00046 , 0.000473,
       0.000353, 0.000313, 0.00032 , 0.000394, 0.000439, 0.000458,
       0.000595, 0.000614, 0.000732, 0.003231, 0.003827])
error = np.array([4.5e-05, 3.9e-05, 3.8e-05, 3.6e-05, 3.7e-05, 3.3e-05, 3.4e-05,
       3.0e-05, 3.6e-05, 3.6e-05, 3.3e-05, 3.5e-05, 3.6e-05, 3.7e-05,
...
line_spec, = ax[0].plot(wave_grid,spec,marker='x',markersize=3,
        label='model')
ax[0].errorbar(wave_grid,elipse,color='k',yerr=error/2,
